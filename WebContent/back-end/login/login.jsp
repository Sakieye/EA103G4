...
<%
	AdminsVO adminsVO = (AdminsVO) request.getAttribute("adminsVO"); //AdminsServlet.java (Concroller) 存入req的adminsVO物件 (包括幫忙取出的adminsVO, 也包括輸入資料錯誤時的adminsVO物件)
%>
					...
					<div class="card-body p-0">
						...
						<div class="row">
							<div class="col-lg-6 d-none d-lg-block"
								style="background-image:url(<%=request.getContextPath()%>/images/login/logo.png);"></div>
							<div class="col-lg-6">
								<div class="p-5">
									...
									<form method="post"
										action="<%=request.getContextPath()%>/back-end/admins/admins.do"
										class="user">
										<%-- 錯誤表列 --%>
