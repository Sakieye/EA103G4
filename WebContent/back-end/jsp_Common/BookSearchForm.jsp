...
<div class="form-row">
	...
	<div class="col-md-2">
		<label for="publicationDateMax">出版日期(最晚)</label>
		<input type="date" class="form-control" id="publicationDateMax" name="publicationDateMax" value='${param.publicationDateMax}'>
	</div>
	<div class="col-md-3">
