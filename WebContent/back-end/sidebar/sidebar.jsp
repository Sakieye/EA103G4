...
<%
    List<PermissionDelimitVO> permissiondelimitVO_s = (List<PermissionDelimitVO>) session
...
<nav id="left" class="column">
    <div id="controlbar" class="position-fixed">
        ...
        <div>
            ...
            <ul>
            <li>&nbsp;&nbsp;<span class="auth2"><a href="#">討論區管理</a></span></li>                         
            <li>&nbsp;&nbsp;<span class="auth2"><a href="#">討論區檢舉管理</a></span></li>             
            </ul>
        </div>
        <div>
