...
<body>
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#csSendGmail${update.index}">詳情</button>
											
	<div class="modal fade" id="csSendGmail${update.index}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
