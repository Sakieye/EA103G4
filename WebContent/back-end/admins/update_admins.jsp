...
<%
List<PermissionDelimitVO> permissiondelimitVO2 = (List<PermissionDelimitVO>) session.getAttribute("permissiondelimitVO2");
            ...
            <div class="min-height-200px">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        ...
                        <a href="<%=request.getContextPath()%>/back-end/admins/listAllAdmins.jsp"><img type="button" id="button" src="<%=request.getContextPath()%>/images/admins/back.png" height="30px" width="30px"></a>
                   </div>
                    </div>
                    <!-- 錯誤表列 -->
                    ...
                    <form method="post" action="admins.do" name="form1" enctype="multipart/form-data">
                        <section>
                            <div class="h3">
                                <td>員工編號:<font color=red><b>*</b></font>
                                </td>
                                <td>${adminsVO.getAdmin_id()}</td>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>姓名:</label> <input type="text" class="form-control" name="admin_name" value="<%=adminsVO.getAdmin_name()%>" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>身分證:<font color=red><b>*</b></font></label>
                                        <div name="admin_id_no">${adminsVO.getAdmin_id_no()}</div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>雇用日期:<font color=red><b>*</b></font></label>
                                        <div name="admin_dutydate">${adminsVO.getAdmin_dutydate()}</div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>密碼:</label>
                                       <input type="text" class="form-control" name="admin_pswd" value="<%=adminsVO.getAdmin_pswd()%>" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Email:</label> <input type="email" class="form-control" name="admin_mail" value="<%=adminsVO.getAdmin_mail()%>" />
                                    </div>
                                </div>
                                
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>手機:</label> <input type="text" class="form-control" name="admin_mobile" value="<%=adminsVO.getAdmin_mobile()%>" />
                                    </div>
                                </div>
                            </div>
                             <hr>
                            ...
                            <div class="col-md-4">
                                    <div class="form-group">
                                        <label>在職狀態:</label> <select class="custom-select form-control" name="admin_jobstate">
                                            ...
                                            <option value="${adminsVO.admin_jobstate == 1 ? 0:1}">${adminsVO.admin_jobstate == 1?"離職":"在職"} </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <label>地址:</label>
                                        <div id="zipcode3">
                                            <div class="f5" data-role="county" name="city"></div>
                                            <div class="f5" data-role="district" name="town"></div>
                                            <input type="text" class="f13 address form-control" style="margin-top: 10px" value="<%=adminsVO.getAdmin_address()%>" name="address">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group pull">
                                            ...
                                            <c:forEach var="permissiondelimitVO" items="${permissiondelimitSvc.all}">
                                                <span class="nike"><label><input type="checkbox" name="per_id[]" class="check1" value="${permissiondelimitVO.per_id}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                       <input type="hidden" name="action" value="update"> <input type="hidden" name="admin_id" value="<%=adminsVO.getAdmin_id()%>"> <input type="hidden" name="admin_id_no" value="${adminsVO.admin_id_no}"> <input type="hidden" name="admin_dutydate" value="${adminsVO.admin_dutydate}">
