...
String categoryName = categoryService.getByCategoryID(categoryID).get().getCategoryName();
String publisherName = publisherService.getOnePublisher(book.getPublisherID()).getPublisher_Name();
String languageID = book.getLanguageID();
String languageName = null;
if (languageID != null){
	languageName = languageService.getOneLanguage(languageID).getLanguage_Name();
}
%>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <main class="col-md-12" style="margin:0 auto;">
        <h1 style="display: inline;">編輯既有商品</h1>
        <div style="position: relative; left:69.5em; display: inline;"><a href="${pageContext.request.contextPath}/UpdateBookPic?bookID=${book.bookID}" target="_blank">編輯商品預覽圖</a></div>
        <div style="position: relative; left:71.5em; display: inline;"><a href="${pageContext.request.contextPath}/BookManagement">返回商品上下架管理</a></div>
        <form action="${pageContext.request.contextPath}/BookUpdateOne?bookID=${book.bookID}" method="post">
            <div class="form-row" style="padding-bottom:10px;">
                ...
                <div class="col-md-2">
                    ...
                    <input id="isbn" name="isbn" type="text" class="form-control" name="isbn" value='${book.isbn}' maxlength="13">
                    <div class="help-block with-errors"></div>
                </div>
                <div class="col-md-3">
                    <label for="publisherName" class="control-label">出版社名稱(完整)</label>
                    <input type="text" class="form-control" id="publisherName" name="publisherName" value='<%=publisherName %>' required>
                    <div class="help-block with-errors"></div>
                </div>
                <div class="col-md-3">
            ...
            <div class="form-row" style="padding-bottom:10px;">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="bookNameOriginal" name="bookNameOriginal" value='${book.bookNameOriginal}'>
                    <div class="help-block with-errors"></div>
                </div>
                <div class="col-md-1">
                    <label for="listPrice" class="control-label">定價</label>
                    <input type="text" class="form-control" id="listPrice" name="listPrice" value='${book.listPrice}' required>
                    <div class="help-block with-errors"></div>
                </div>
                <div class="col-md-1">
                    <label for="salePrice" class="control-label">預設售價</label>
                    <input type="text" class="form-control" id="salePrice" name="salePrice" value='${book.salePrice}' required>
                    <div class="help-block with-errors"></div>
                </div>
                <div class="col-md-1">
                    <label for="bookBP" class="control-label">紅利點數</label>
                    <input type="text" class="form-control" id="bookBP" name="bookBP" value='${book.bookBP}' required>
                    <div class="help-block with-errors"></div>
                </div>
                <div class="col-md-1">
                    <label for="isSold">上架狀態</label>
                    <select name="isSold" id="isSold" class="form-control" name="isSold" value='${book.isSold}'>
                ...
                <div class="col-md-1">
                    ...
                    <input type="text" class="form-control" id="safetyStock" name="safetyStock" value='${book.safetyStock}' required>
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            <div class="form-row" style="padding-bottom:10px;">
                <div class="col-md-4">
                    ...
                    <select name="category" id="category" class="form-control" name="category" required>
                        <option value="${book.categoryID}" selected><%=categoryName%></option>
                ...
                <div class="col-md-2">
                    ...
                    <select name="language" id="language" class="form-control" name="language">
                        <option value="${book.languageID}" selected><%=languageName%></option>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="bookIntro" rows="20" name="bookIntro" required>${book.bookIntro}</textarea>
                <div class="help-block with-errors"></div>
            </div>
            <%-- 錯誤表列 --%>
