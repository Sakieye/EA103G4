...
<body>
	...
	<main class="col-md-12" style="margin: 0 auto;">
		...
		<div style="position: relative; left: 69.5em; display: inline;">
			<a href="${pageContext.request.contextPath}/UpdateBookPic?bookID=${book.bookID}" target="_blank">編輯商品預覽圖</a>
		</div>
		<div style="position: relative; left: 71.5em; display: inline;">
			<a href="${pageContext.request.contextPath}/BookManagement">返回商品上下架管理</a>
		</div>
