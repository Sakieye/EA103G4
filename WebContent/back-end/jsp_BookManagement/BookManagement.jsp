    ...
    <div id="container">
        <main id="center" class="column">
            ...
            <form method='post' action='${pageContext.request.contextPath}/BookManagement'>
                ...
                <span style="float:right; color:red; font-size:12px">*售價是指當下定價、預設售價、促銷售價之中最低者<br>
                *折扣是以預設售價為準
                </span>
            </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#isSold0').click(function(){
            	...
            	$.post('${request.header("Referer")}?isSold=0', {bookList:bookList}, alert("下架成功！請重新查詢確認"));
            })
            ...
            $('#isSold1').click(function(){
                ...
                $.post('${request.header("Referer")}?isSold=1', {bookList:bookList}, alert("上架成功！請重新查詢確認"));
            })
		});
    </script>
</body>
