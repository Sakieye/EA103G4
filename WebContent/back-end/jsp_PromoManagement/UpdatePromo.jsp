...
<%
	...
	String promoStartTime = promo.getPromoStartTime().toString();
...
<body>
	...
	<main class="col-md-12" style="margin: 0 auto;">
		<h1 style="display: inline;">編輯促銷事件</h1>
		<div style="position: relative; left: 79em; display: inline;">
			<a href="${pageContext.request.contextPath}/PromoManagement">返回促銷事件管理</a>
		</div>
		<form role="form" action="${pageContext.request.contextPath}/UpdatePromo?promoID=${promo.promoID}" method="post">
			<div class="form-row">
				<div class="col-md-3">
