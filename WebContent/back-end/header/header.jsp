...
<body>
	...
	<header id="header">
		<div>
			<div id="logo">
				<a
					href="<%=request.getContextPath()%>/back-end/login/loginSuccess.jsp">部客匣管理後台<span>
...
<!--                 </svg> -->
                   ...
                   <form style="margin: 0px; display: inline" method="post"
					...
					<label style="cursor: pointer"><img class="rounded-circle" width="45px" height="45px" src="${pageContext.request.contextPath}/ShowAdminPic?admin_id=<%=admin_id_s %>" id="img"/>&nbsp;               
				<b><%=admin_name_s%></b>
				...
				<form style="margin: 0px; display: inline" method="post"
					...
					<input type="hidden" name="action" value="logout"> <label
						style="cursor: pointer">(登出) <input type="submit"
